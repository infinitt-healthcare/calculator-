...
void CcalculatorDlg::OnBnClickedButton16()
{
	...
	case 1:
		...
		break;
	case 2:result = _ttoi(m_op1.GetBuffer()) - _ttoi(m_op2.GetBuffer());
		break;
	case 3:result = _ttoi(m_op1.GetBuffer()) * _ttoi(m_op2.GetBuffer());
		break;
	case 4:result = _ttoi(m_op1.GetBuffer()) / _ttoi(m_op2.GetBuffer());
		break;
	}
